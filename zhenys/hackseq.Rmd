...
- Writing down Rmarkdown memo to share the knowledge with biologists and perform reproducible research
- Adopting Clean code style to facilitate the code maintenance in the future studies
- Asking an interesting Question first and then analyze the raw data step by step
