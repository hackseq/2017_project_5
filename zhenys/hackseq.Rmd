...
- Writing down Rmarkdown memo to share the analysis protocol with biologists and perform reproducible research,
  which is already achived in other sciences [].
...
My biological question is, what are the novel determinants involved in LR patterning during heart development? To tackle
this problem using the public data, I will perform post Quality control (post-QC) procedure and then 
